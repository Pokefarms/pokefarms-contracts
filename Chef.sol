...
contract  PokeFarmingBank is IERC721Locker, OwnableUpgradeable, ReentrancyGuard, ContractGuard {
    ...
    struct PoolInfo {
        ...
        address strategy; // Strategy address, use LP to farm and buy back PokeCashs
    ...
    //   > In-game Treasury:        5,250,000 (29.41%)
    //   > Jackpot Treasury:        0  (0)
    //   > Insurance Fund:          0  (0)
    ...
    function changeStrategy(uint256 _pid, address _newStrategy) external onlyOwner {
        ...
        if (_newStrategy != address(0)) {
            ...
            require(IStrategy(_newStrategy).targetProfitToken() == pokecash, "!targetProfitToken");
    ...
    function _topupFunds(uint256 _claimableAmount) internal {
        ...
        if (
            ...
            ICappedMintableBurnableERC20(_pokecash).mint(jackpotFund, _jackpotAmount);
